...
import { logtag, taggedLogger, tlog } from "../src";

console.clear();

const t = (t: string, c?: string, b?: string) => logtag(t, { background: c, border: b });

const app = taggedLogger("App", "#7424FF");
const conf = taggedLogger("Preferences", "#DB7700");
const login = taggedLogger("Auth", "#E912FF");
const cat = taggedLogger("Catalog", "#37FFC8");
...
const entries: [delay: number, fn: Function, ...rest: any[]][] = [
    ...
    [100, app, "logged in"],
    [500, cat, "requesting content"],
    [800, cat, "loading media"],
    [500, app, "rendering"],
